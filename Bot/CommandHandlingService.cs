...
public class CommandHandlingService
{
    ...
    public async Task Initialize()
    {
        try
        {
            ...
            this.client.ModalSubmitted += new ModalHandlers(this.services.GetRequiredService<NoHesiBotContext>()).ModalHandler;
